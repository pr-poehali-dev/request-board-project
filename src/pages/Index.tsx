        ...
        >
            {[...categories.slice(0, 9), ...categories.slice(0, 9)].map((category, index) => {
              ...
              <div
                ...
                className="flex-shrink-0 relative overflow-hidden rounded-2xl border border-indigo-100 shadow-lg transition-all duration-300 cursor-pointer group"
              ...
              >
                ...
                {hoveredCategory === category.name && category.subcategories && (
                  <div 
                    className="absolute left-full top-0 ml-2 w-64 bg-white rounded-xl shadow-2xl border border-purple-200 p-4 z-50 animate-in slide-in-from-left-2 duration-200"
                    style={{ height: '200px' }}
                  >
