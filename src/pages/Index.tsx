      ...
      <main id="feed-start" className="container mx-auto px-3 sm:px-6 lg:px-8 pb-24 md:pb-8 pt-12" style={{ maxWidth: '1400px' }}>
        <div className="flex gap-6">
          ...
          {activeTab === 'requests' && (
            ...
            >
            <h2 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent mb-4 mt-8">
              Запросы
            </h2>
        ...
        {activeTab === 'offers' && (
          <div 
            ...
            onTouchEnd={handleTouchEnd}
          >
            <h2 className="text-2xl sm:text-3xl font-bold text-pink-600 mb-4 mt-8">
              Предложения
            </h2>
            <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide md:hidden">
              <Button
